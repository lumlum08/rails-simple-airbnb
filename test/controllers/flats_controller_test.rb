...
class FlatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flat" do
    assert_difference('Flat.count') do
      post flats_url, params: { flat: { adress: @flat.adress, description: @flat.description, name: @flat.name, number_of_guests: @flat.number_of_guests, price_per_night: @flat.price_per_night } }
    end
  ...
  test "should update flat" do
    patch flat_url(@flat), params: { flat: { adress: @flat.adress, description: @flat.description, name: @flat.name, number_of_guests: @flat.number_of_guests, price_per_night: @flat.price_per_night } }
